...
![WriteDateValue command editor](WriteDateValue.png)
</p>**

**<p style="text-align: center;">
`WriteDateValue` Command Editor (<a href="../WriteDateValue.png">see full-size image</a>)
</p>**
...
See the [automated tests](https://github.com/OpenCDSS/cdss-app-tstool-test/tree/master/test/commands/WriteDateValue).
