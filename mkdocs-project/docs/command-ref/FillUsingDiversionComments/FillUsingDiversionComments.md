...
**<p style="text-align: center;">
`FillUsingDiversionComments` Command Editor for CIU Parameters
</p>**
...
See the [automated tests](https://github.com/OpenWaterFoundation/cdss-app-tstool-test/tree/master/test/regression/commands/general/FillUsingDiversionComments).

A sample command file to fill time series from the [State of Colorado’s HydroBase database](../../datastore-ref/CO-HydroBase/CO-HydroBase)
is as follows:
