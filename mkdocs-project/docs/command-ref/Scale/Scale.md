...
<a href="../Scale.png">See also the full-size image.</a>
...
See the [automated tests](https://github.com/OpenWaterFoundation/cdss-app-tstool-test/tree/master/test/regression/commands/general/Scale).

The following example scales a precipitation time series from the [State of Colorado’s HydroBase database](../../datastore-ref/CO-HydroBase/CO-HydroBase)
by a factor of `3.5`:
...
See also the [`ConvertDataUnits`](../ConvertDataUnits/ConvertDataUnits)
...
* [`ConvertDataUnits`](../ConvertDataUnits/ConvertDataUnits) command
