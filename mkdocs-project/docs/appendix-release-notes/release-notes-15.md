...
**Feature release to update from Java 8 to Java 11.**
...
*   ![new](new.png) [15.0.0] Add ***Tools / File Manager***:
    ...
    +   Future enhancements will utilize these features to improve performance.
...
*   ![new](new.png) [15.0.0] Add ***Tools / TSTool Installation Manager***:
    +   See the [Tools / Installation Manager](../tools/tools.md#installation-manager) documentation.
